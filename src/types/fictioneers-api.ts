...
export interface components {
  schemas: {
    ...
    MetaSerializer: {
       ...
       * @default []
       */
      changed_timeline_events?: components["schemas"]["UserTimelineEventSerializer"][];
      /**
       * Changed Timeline Event States
       * @default []
       */
      changed_timeline_event_states?: components["schemas"]["UserTimelineEventStateChangeSerializer"][];
      /** @default ONLINE */
    ...
    /**
     * ResponseListSerializer[UserTimelineEventSerializer]
     * @description Base serializer class for all list responses, inheriting error and metadata from
     * ResponseSerializer.
     */
    ResponseListSerializer_UserTimelineEventSerializer_: {
      /** Data */
      data?: components["schemas"]["UserTimelineEventSerializer"][];
      /** Error */
      error?: components["schemas"]["ErrorSerializer"] | null;
      /** Meta */
      meta?: components["schemas"]["MetaSerializer"] | null;
    };
    /**
     * ResponseListSerializer[UserTimelineEventStateChangeSerializer]
     * @description Base serializer class for all list responses, inheriting error and metadata from
     * ResponseSerializer.
     */
    ResponseListSerializer_UserTimelineEventStateChangeSerializer_: {
      /** Data */
      data?: components["schemas"]["UserTimelineEventStateChangeSerializer"][];
      /** Error */
      error?: components["schemas"]["ErrorSerializer"] | null;
      /** Meta */
      meta?: components["schemas"]["MetaSerializer"] | null;
     ...
     */
    ResponseSerializer_UserSerializer_: {
    ...
    /**
     * ResponseSerializer[UserStoryStateSerializer]
     * @description Base serializer class for all responses.
     */
    ResponseSerializer_UserStoryStateSerializer_: {
      data?: components["schemas"]["UserStoryStateSerializer"];
      /** Error */
      error?: components["schemas"]["ErrorSerializer"] | null;
      /** Meta */
      meta?: components["schemas"]["MetaSerializer"] | null;
    ...
    /**
     * ResponseSerializer[UserTimelineEventSerializer]
     * @description Base serializer class for all responses.
     */
    ResponseSerializer_UserTimelineEventSerializer_: {
      data?: components["schemas"]["UserTimelineEventSerializer"];
      /** Error */
      error?: components["schemas"]["ErrorSerializer"] | null;
      /** Meta */
    ...
    TimelineEventSerializer: {
      ...
      content_integrations: {
        [key: string]: components["schemas"]["ContentIntegrationSerializer"][];
      };
    };
    /**
     * Timeline
     ...
     * @description All states a User can update a UserTimelineEvent state value to over API.
     * @enum {string}
     */
    UserInvokedTimelineEventState:
      | "AVAILABLE"
    ...
    UserSerializer: {
      ...
      narrative_state?:
        | components["schemas"]["UserStoryStateSerializer"]
        | null;
    };
    /**
     * UserStoryState
    ...
    UserStoryStateSerializer: {
       ...
       */
      current_beat?: components["schemas"]["BeatSerializer"] | null;
      /**
       * New Beat Available
       ...
       * }
       */
      new_beat_available?: components["schemas"]["BeatSerializer"] | null;
      /**
    ...
    UserTimelineEventSerializer: {
       ...
       */
      available_beat?: components["schemas"]["BeatSerializer"];
       ...
       * ]
       */
      narrative_event_content: components["schemas"]["ContentIntegrationSerializer"][];
      /**
     ...
     * @description All states UserTimelineEvent entities can be in.
     * @enum {string}
     */
    UserTimelineEventState:
      | "INITIAL"
    ...
    UserTimelineEventStateChangeSerializer: {
       ...
       * ]
       */
      state_change_content: components["schemas"]["ContentIntegrationSerializer"][];
      /**
       * Timeline Event Id
       * @example PYztAWXDPnz4BM6qDzx4
       */
...
export interface operations {
  ...
  generate_tokens_v1_auth_token_post: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["EphemeralTokenSerializer"];
        };
      };
      /** Validation Error */
      422: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["TokenDeserializer"];
      };
    };
  };
  /**
  ...
  token_info_v1_auth_introspect_token_post: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["TokenIntrospectionSerializer"];
        };
      };
      /** Validation Error */
      422: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["TokenIntrospectionDeserializer"];
      };
    };
  };
  /** Retrieve detailed representation of the current user (and user story state). */
  get_user_me_v1_users_me_get: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["ResponseSerializer_UserSerializer_"];
        };
      };
  ...
  create_user_v1_users_post: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["CreateUserDeserializer"];
      };
    };
  };
  /** Representation of authenticated users narrative story state. */
  get_user_story_state_v1_user_story_state_get: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["ResponseSerializer_UserStoryStateSerializer_"];
        };
      };
      /** Authentication Required */
      401: {
  ...
  patch_user_story_state_v1_user_story_state_patch: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["PatchStoryStateDeserializer"];
      };
    };
  };
  /** Progress events based on the authenticated user available transition events. */
  step_events_for_user_via_post_v1_user_story_state_progress_events_post: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ProgressEventsDeserializer"];
      };
    };
  };
  /**
  ...
  list_timeline_events_for_user_v1_user_timeline_events_get: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["ResponseListSerializer_UserTimelineEventSerializer_"];
        };
      };
      /** Authentication Required */
      401: {
  ...
  update_user_timeline_event_v1_user_timeline_events__timeline_event_id__patch: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["ResponseSerializer_UserTimelineEventSerializer_"];
        };
      };
      /** Authentication Required */
      401: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["PatchUserTimelineEventDeserializer"];
      };
    };
  };
  /**
  ...
  get_user_timeline_event_state_changes_v1_user_timeline_event_state_changes_get: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["ResponseListSerializer_UserTimelineEventStateChangeSerializer_"];
        };
      };
      /** Authentication Required */
      401: {
  ...
  get_timelines_v1_timelines_get: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["TimelineSerializer"][];
        };
      };
      /** Rate limit exceeded */
      429: {
  ...
  list_timeline_timeline_events_v1_timelines__timeline_id__timeline_events_get: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["TimelineEventSerializer"][];
        };
      };
      /** Validation Error */
      422: {
  ...
  get_timeline_users_v1_timelines__timeline_id__users_get: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["UserSerializer"][];
        };
      };
      /** Validation Error */
      422: {
  ...
  list_all_timeline_event_state_changes_v1_timelines__timeline_id__event_state_changes_get: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["EventStateChangeSerializer"][];
        };
      };
      /** Validation Error */
      422: {
